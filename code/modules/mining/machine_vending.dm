...
/obj/machinery/mineral/equipment_vendor/Initialize(mapload)
	...
	prize_list["Gear"] = list(
		...
		/* Epsilon changes start*/
		EQUIPMENT("SEVA Suit",						/obj/item/clothing/suit/hooded/explorer/seva, 						1000),
		EQUIPMENT("SEVA Mask",						/obj/item/clothing/mask/gas/seva, 									100),
		EQUIPMENT("Explorer Exoskeleton",			/obj/item/clothing/suit/hooded/explorer/exo, 						1000),
		EQUIPMENT("M40 Mask",						/obj/item/clothing/mask/gas/exo, 									100),
		/*Epsilon changes end*/
